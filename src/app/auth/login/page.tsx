...
const LoginPage = () => {
  ...
  // 🔒 Disable scroll when this page is open
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 flex flex-col lg:flex-row bg-[#F2F4F8] overflow-hidden">
      {/* LEFT IMAGE */}
      <div className="hidden lg:flex w-1/2 h-full items-center justify-center overflow-hidden rounded-3xl p-4">
      ...
      {/* RIGHT SIDE CONTENT */}
      <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-12 overflow-hidden">
        {/* Logo */}
        <div className="flex items-center justify-center gap-3 mb-10">
          ...
          />
          <h5 className="text-3xl font-semibold text-[#0A0A0A]">Ehen Tours</h5>
        </div>

        {/* Main Card */}
        <div className="w-full max-w-md bg-white rounded-[20px] shadow-md p-6 sm:p-8 overflow-hidden">
          {/* STEP 1: LOGIN */}
          {step === "login" && (
            <div className="flex flex-col gap-5 items-center w-full">
              <h2 className="text-[26px] font-bold text-center">Welcome back</h2>
              ...
              <button
                ...
                className="w-full bg-[#0057FF] text-white rounded-lg py-3 hover:bg-blue-600 transition"
              >
                Continue
              </button>
          ...
          {step === "forgot" && (
            <div className="flex flex-col gap-6 items-center w-full">
              ...
              <p className="text-center text-[#667085] text-sm max-w-[400px] leading-relaxed">
                No problem, Just enter your email address below — we`ll send you an OTP Code to reset password
              </p>
          ...
          {step === "otp" && (
            <div className="flex flex-col gap-6 items-center w-full">
              <h2 className="text-[26px] font-bold text-center mb-2">OTP Verification</h2>
              <p className="text-center text-[#667085] text-sm">
                OTP sent to <span className="font-medium">{email || "demo@gmail.com"}</span>
              </p>
              ...
              <div className="flex gap-3 mt-3">
                {otp.map((o, i) => (
                  <input
                    ...
                    type="text"
                    maxLength={1}
                    className="w-[60px] h-[60px] border-2 border-[#F04438] rounded-lg text-center text-2xl focus:ring-2 focus:ring-blue-400"
                    value={o}
          ...
          {step === "password" && (
            <div className="flex flex-col gap-6 items-center w-full">
              <h2 className="text-[26px] font-bold text-center mb-3">Create New Password</h2>
          ...
          {step === "success" && (
            <div className="flex flex-col gap-4 items-center w-full text-center">
              <Image src="/right.png" alt="success" width={120} height={120} />
              ...
              <button
                onClick={() => setStep("login")}
                className="bg-[#0057FF] text-white rounded-lg py-3 w-full mt-4 hover:bg-blue-600 transition"
              >
                Continue
              </button>
            </div>
        ...
        {/* Footer */}
        <div className="mt-6 text-sm text-[#3A3A3A] text-center">
