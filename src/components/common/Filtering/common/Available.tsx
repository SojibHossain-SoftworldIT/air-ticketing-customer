...
const AvailableFilters = ({ flights, selectedTab, compareList, setCompareList, compareMode, setCompareMode }: any) => {
  ...
  return (
    <div className="py-6">
      ...
      {/* Top Bar */}
      <div className={`flex items-center justify-between ${selectedTab !== "Bus" && "bg-white rounded-xl border border-[#E6E7EA]"}   p-4`}>
