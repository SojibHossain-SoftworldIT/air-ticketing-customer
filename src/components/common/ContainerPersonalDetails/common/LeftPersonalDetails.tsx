...
const LeftPersonalDetails = ({ background, passengerDetails, setPassengerDetails }: any) => {
  return (
    <div>
      ...
      <div className={`w-[360px]  ${background}   rounded-2xl border border-gray-200 p-5 `}>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#EFF6FF] border border-blue-100 rounded-xl p-4 mt-4">
            ...
            {
              passengerDetails ? (
                <button onClick={() => setPassengerDetails(false)} className="w-full flex items-center justify-center gap-2 bg-blue-600 text-white text-sm font-medium py-2.5 rounded-lg hover:bg-blue-700 transition">
